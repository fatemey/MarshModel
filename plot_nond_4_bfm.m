...
%--------------------- Graph 3 --------------------
load co_data_Qfx2; conv = dat(:,7);
Chi = dat(:,2);    % Nonstable  equilibrium tidal flat width
C_o = dat(:,1);    % ocean concertation (kg/m3)

Q_f = 40;          % river water discharge (m3/s)
...
legend([p3(1),p2(1),p1(1)],['z = ' num2str(z3)],['z = ' num2str(z2)],['z = ' num2str(z1)],'location','northwest')
