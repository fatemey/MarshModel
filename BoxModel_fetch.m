function output = BoxModel_fetch (b_f_0)
% BoxModel_fetch: (based on BoxModel_SA.mat as of 2/7/2017)
% A function of initila tidal flat width to find a threshold for fetch
% value wich results in either total marsh expansion or tifdal flat
% expansion.
%
% Input
%           b_f_0 : intial width of tidal flat
% Output
%           output : distance between first and tenth tidal flat width
%           values 
%
...
y0(1) = b_f_0; %b_fm/2;   % tidal flat width (m)
