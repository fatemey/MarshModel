...
load co_data_1000yr; bf_0=dat(:,2); %bf_0(19:20)=[1500,1500];
C_o_V = 5:5:100;

Sol = zeros(length(C_o_V),4);
for i = 12 : 12%1 : length(C_o_V)
    i
    ...
    options = optimoptions('fmincon','Algorithm','interior-point','Display','final','StepTolerance',1e-500,'ConstraintTolerance',1e-20,'MaxFunctionEvaluations',100000,'MaxIterations',100000,'OptimalityTolerance',1e-100,'OutputFcn',@outfun); %'Algorithm','active-set','sqp'
