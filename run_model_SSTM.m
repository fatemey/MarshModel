function run_model_SSTM
% Runs BoxModel_SS_2eq and CriticaIFetch_TM
%
                ...
                for i5 = 1 : k5
                    for i6 = 1 : k6
                        for i7 = 1 : k7
                            for i8 = 1 : k8
                                for i9 = 1 : k9
                                    Sol = BoxModel_SS_2eq(Co(i1),Cf(i2),LE(i3),Qf(i4),R(i5),H(i6),T(i7),bfm(i8),vw(i9),bf0); % Sol = [x,y,fval_x,fval_y]
