...
%--------------------- Graph 1 --------------------
load co_data_bfmby2; conv = dat(:,7);
...
%--------------------- Graph 3 --------------------
load co_data_bfmx2; conv = dat(:,7);
Chi = dat(:,2);    % Nonstable  equilibrium tidal flat width
C_o = dat(:,1);    % ocean concertation (kg/m3)

b_fm = 20 *10^3;  % total basin width (both sides of the channel) (m)
...
%--------------------- Graph 4 --------------------
load co_data_bfmx4; conv = dat(:,7);
Chi = dat(:,2);    % Nonstable  equilibrium tidal flat width
C_o = dat(:,1);    % ocean concertation (kg/m3)

b_fm = 40 *10^3;  % total basin width (both sides of the channel) (m)
