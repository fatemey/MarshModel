function tidalflatmarsh_convertion
% tidalflatmarsh_convertion: checks for tidal flat or marsh conversion to marsh or tidal flat based on different set of parametrs.
