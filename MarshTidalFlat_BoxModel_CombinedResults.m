function MarshTidalFlat_BoxModel_CombinedResults
% MarshTidalFlat_BoxModel_CombinedResults : This function splitts the time
% period and uses the function MarshTidalFlat_BoxModel_SplittedResults for
