% function [t, y] = BoxModel_Linearized
function BoxModel_Linearized
% BoxModel_Linearized: Models linearized 0d marsh and tidal flat time
% evolution based on linearezied tau/wave power and submergence time. Functtion fetch_threshold is
% using Matlab ode23tb function.
%
% Output
...
y0(1) = 2;%b_fm/2;      % tidal flat width (m)
