function x = CriticalInitialWidth_Linearized
% Function CriticalInitialWidth_Linearized looks for a critical fetch value based on
% different values of a variable of interest based on linearezied tau/wave power and submergence time. Functtion fetch_threshold is
...
for k = 4 : 4
    ...
    switch par
        case 1
            par_v = 50 *10^-3 : 50 *10^-3 : 100 *10^-3; % for C_o
        ...
        case 3
            ...
            TF_width = 5 : 5 : b_fm-5;
        case 4
            par_v = 1 *10^3 : 4 *10^3 : 9 *10^3; % for L_E
            TF_width = 100 : 100 : b_fm-100;
        case 5
...
%======================= Nested Function =========================
    function dy = ode4marshtidalflat_Linearized (t,y) %  y1=b_f, y2=d_f, y3=d_m, y4=u (=C_r*(b_f*d_f+b_m*d_m, why solving u instead of C_r? u is the variable on the left hand side of mass conservation equation.)
        ...
        if  flag_f2m==1 || chi<=b_r || v_w==0 % condition for no bed and margin erosion in case of a filled mudflat or no wind
            ...
            tau = 0.381762 + 5.37041*10^-6 * local - 0.0728637 * y(2);
            W = -13.788 + 0.000591921 * local + 27.7457 * y(2);
        end
