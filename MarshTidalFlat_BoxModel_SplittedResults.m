function [y, t] = MarshTidalFlat_BoxModel_SplittedResults (t1, t2, y0,v_w)
% MarshTidalFlat_BoxModel_SplittedResults : Modeling 0d marsh and tidal flat time
% evolution using Matlab ode15s function for sensitivity analysis. This
% function uses splitted time periods to be used in MarshTidalFlat_BoxModel_CombinedResults
%
